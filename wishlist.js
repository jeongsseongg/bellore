  ...
  function decorateCards() {
    $$('.hcard').forEach(function (card) {
      ...
      if (!card.querySelector('.hcard-actions')) {
        ...
        var inCollection = !!card.closest('#collection, #homeOnSale');
        box.innerHTML =
          '<button type="button" class="hcard-wish" aria-label="찜"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg></button>' +
          (inCollection ? '' : '<button type="button" class="hcard-cart" aria-label="장바구니"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.7 13.4a2 2 0 0 0 2 1.6h9.7a2 2 0 0 0 2-1.6L23 6H6"/></svg></button>');
        (inCollection ? card.querySelector('.hcard-img') : card).appendChild(box);
      }
      syncCardState(card);
    });
  }
