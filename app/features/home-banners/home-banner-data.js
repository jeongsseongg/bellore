...
export const HERO_CAMPAIGNS = [
  ...
  { action: 'wedding', lead: '함께할 시간을 고르는 순간', title: '예물 시계', sub: '롤렉스 · 까르띠에 · 불가리', image: 'assets/banners/hero-02.webp', tone: 'light', position: 'top-left', filter: { brandsAny: ['롤렉스', '까르띠에', '불가리', '샤넬'] } },
  ...
  { action: 'icons', lead: '시대를 대표하는 이름', title: '아이코닉 컬렉션', sub: '롤렉스 · 오메가 · 까르띠에 · 튜더', image: 'assets/banners/hero-04.webp', tone: 'light', position: 'top-left', compact: true, filter: { termsAny: ['데이트저스트', '데이저스트', '스피드마스터', '산토스', '블랙베이'] } },
  { action: 'newest', lead: '검수를 마치고 새롭게', title: 'NEW ARRIVAL', sub: '오늘 새롭게 만나는 시계', image: 'assets/banners/hero-05.webp', filter: { sort: 'latest' } },
  { action: 'highend', lead: '시간을 넘어 남는 이름', title: '1,000만원 이상의 명작', sub: '파텍필립 · 오데마피게 · 롤렉스', image: 'assets/banners/hero-06.webp', filter: { min: 10000000 } },
