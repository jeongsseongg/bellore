  ...
  ready(function () {
    ...
    function bannerEditView(item) {
      ...
      bnBody.innerHTML =
        ...
        '<p class="muted small">휴대폰 화면용 · 권장 <b>1080 × 1080px</b> (정사각)</p><div id="bannerPhoto"></div></div>' +
        ...
        '<p class="muted small">가로 와이드 · 권장 <b>2400 × 1000px</b> · 없으면 태블릿/모바일 사용</p><div id="bannerPhotoPc"></div></div>' +
