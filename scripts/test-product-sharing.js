...
(async () => {
  ...
  for (const [asset, releaseKey] of [
    ['script.js', '20260826-admin-catalog-v1'],
    ['app/bootstrap.js', '20260826-admin-catalog-v1'],
    ['sw.js', '20260826-admin-catalog-v1'],
    ['wishlist.js', '20260826-admin-catalog-v1'],
    ['search.js', '20260826-admin-catalog-v1'],
  ]) {
