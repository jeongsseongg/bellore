...
assert.match(sw, /bellore-v352-sell-request-persistence/, 'latest service worker cache namespace must preserve Naver Pay and include the sell persistence repair');
