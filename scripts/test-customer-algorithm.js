...
assert.match(html, /app\/legacy\/recommendation-engine\.js\?v=20260826-payment-full-v2/);
assert.match(html, /ai-advisor\.js\?v=20260826-payment-full-v2/);
assert.match(html, /payments\.js\?v=20260826-payment-full-v2/);
