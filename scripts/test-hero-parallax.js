...
(async () => {
  ...
  assert.match(bootstrap, /import \{ initHeroParallax \} from '\.\/ui\/hero-parallax\.js\?v=20260825-home-typography-admin-layout-v8';/, 'bootstrap imports the fixed banner module with an exact release key');
