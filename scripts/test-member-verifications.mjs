...
assert.match(lifecycleMigration, /bellore-member-delete-recovery/);
...
assert.match(memberOps, /select\("suspended"\)/);
assert.match(memberOps, /shouldBeSuspended/);
assert.match(memberOps, /AUTH_ROLLBACK_FAILED/);
