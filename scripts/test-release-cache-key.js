...
const releaseKey = '20260826-hero-campaigns-v4';
...
assert.match(serviceWorker, /const VERSION = "bellore-v292-hero-campaigns";/, 'service-worker cache namespace must advance with the release');
