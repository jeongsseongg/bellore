...
const releaseKey = '20260825-customer-feedback-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v283-customer-feedback";/, 'service-worker cache namespace must advance with the release');
