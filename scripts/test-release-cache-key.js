...
const releaseKey = '20260824-phase7-11-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v268-phase7-11";/, 'service-worker cache namespace must advance with the release');
