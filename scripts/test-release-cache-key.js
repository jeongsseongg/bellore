...
const releaseKey = '20260825-home-route-admin-v7';
...
assert.match(serviceWorker, /const VERSION = "bellore-v282-home-route-admin";/, 'service-worker cache namespace must advance with the release');
