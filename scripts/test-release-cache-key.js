...
assert.match(serviceWorker, /const VERSION = "bellore-v344-admin-member-lifecycle";/, 'service-worker cache namespace must advance for the integrated member lifecycle release');
