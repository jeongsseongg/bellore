...
const releaseKey = '20260825-home-search-unified-v5';
...
assert.match(serviceWorker, /const VERSION = "bellore-v280-home-search-unified";/, 'service-worker cache namespace must advance with the release');
