...
assert.match(serviceWorker, /const VERSION = "bellore-v343-naverpay-test-session";/, 'service-worker cache namespace must advance for the Naver Pay test session release');
