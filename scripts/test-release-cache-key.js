...
assert.match(serviceWorker, /const VERSION = "bellore-v342-naverpay-bottom-action";/, 'service-worker cache namespace must advance for the Naver Pay bottom action release');
