...
assert.match(serviceWorker, /const VERSION = "bellore-v337-member-verification-live";/, 'service-worker cache namespace must advance for the hero layout final release');
