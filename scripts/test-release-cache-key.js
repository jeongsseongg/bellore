...
const signupStyleKey = '20260827-auth-signup-v1';
const signupScriptKey = '20260827-signup-history-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v352-sell-request-persistence";/, 'service-worker cache namespace must preserve the restored sell request path');
