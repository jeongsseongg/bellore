...
const releaseKey = '20260826-home-compose-v2';
...
assert.match(serviceWorker, /const VERSION = "bellore-v290-home-compose-merged";/, 'service-worker cache namespace must advance with the release');
