...
const releaseKey = '20260826-coupon-checkout-feedback-v3';
...
assert.match(serviceWorker, /const VERSION = "bellore-v287-coupon-checkout-feedback";/, 'service-worker cache namespace must advance with the release');
