...
const releaseKey = '20260826-search-checkout-address-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v289-home-compose";/, 'service-worker cache namespace must advance with the release');
