...
const releaseKey = '20260826-hero-campaigns-v8';
...
assert.match(serviceWorker, /const VERSION = "bellore-v296-banner-ratio";/, 'service-worker cache namespace must advance with the release');
