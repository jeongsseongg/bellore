...
const releaseKey = '20260826-listing-title-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v286-listing-title-banner-ratio";/, 'service-worker cache namespace must advance with the release');
