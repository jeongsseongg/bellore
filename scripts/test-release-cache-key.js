...
const releaseKey = '20260826-full-release-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v319-full-release";/, 'service-worker cache namespace must advance with the release');
