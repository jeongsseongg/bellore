...
assert.match(serviceWorker, /const VERSION = "bellore-v343-admin-member-lifecycle";/, 'service-worker cache namespace must advance for the integrated member lifecycle release');
