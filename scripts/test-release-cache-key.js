...
const releaseKey = '20260825-home-banner-fit-v1';
...
assert.match(serviceWorker, /const VERSION = "bellore-v276-home-banner-fit";/, 'service-worker cache namespace must advance with the release');
