...
const releaseKey = '20260826-hero-campaigns-v5';
...
assert.match(serviceWorker, /const VERSION = "bellore-v293-card-focus";/, 'service-worker cache namespace must advance with the release');
