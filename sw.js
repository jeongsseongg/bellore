/* 벨로르 PWA 서비스워커 */
const VERSION = "bellore-v329-sell-services-blue";
...
const SHELL_ASSETS = [
  ...
  './mypick.css?v=20260826-hero-layout-v10',
  ...
  './app/features/sell-method/sell-method.css?v=20260826-sell-services-blue-v1',
  './app/features/sell-method/sell-service-navigation.css?v=20260826-sell-services-blue-v1',
  './app/features/sell-method/sell-service-pages.css?v=20260826-sell-services-blue-v1',
  './app/features/sell-method/sell-service-action.css?v=20260826-sell-services-blue-v1',
  './app/features/condition-guide/condition-guide.css?v=20260826-hero-layout-v10',
  './script.js?v=20260826-sell-services-blue-v1',
  './app/legacy/recommendation-engine.js?v=20260826-hero-layout-v10',
  './payments.js?v=20260826-hero-layout-v10',
  ...
  './brands.js',
  './supabase.js?v=20260826-hero-layout-v10',
  './bellore-features.js?v=20260821-product-detail-v1',
  './cq-demo.js?v=20260810-bid-notify-fix',
  './wishlist.js?v=20260826-hero-layout-v10',
  './alerts.js?v=20260820-tabs-alerts-v1',
  './auction.js',
  './search.js?v=20260826-hero-layout-v10',
  './ai-advisor.js?v=20260826-hero-layout-v10',
  './ai-advisor-admin.js?v=20260826-hero-layout-v10',
  './app/bootstrap.js?v=20260826-sell-services-blue-v1',
  './app/features/sell-method/sell-method.js?v=20260826-sell-services-blue-v1',
  './app/features/sell-method/sell-service-pages.js?v=20260826-sell-services-blue-v1',
  ...
  './app/features/home-banners/home-banners.js?v=20260826-hero-layout-v10',
  './app/features/home-banners/home-banner-data.js',
  './app/features/home-merchandising/home-merchandising.js?v=20260826-admin-live-v4',
  './app/features/home-rows/home-rows.js?v=20260826-hero-layout-v10',
  ...
  './app/legacy/legacy-collection.js?v=20260826-hero-layout-v10',
  './app/legacy/home-merchandising-grid.js?v=20260826-admin-live-v4',
  ...
  './app/legacy/page-runtime.js?v=20260826-sell-services-blue-v1',
