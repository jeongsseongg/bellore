/* 벨로르 PWA 서비스워커 */
const VERSION = "bellore-v399-mypage-profile-address";
...
const SHELL_ASSETS = [
  ...
  './app/features/mypage-personal-shop/mypage-requested-actions.js?v=20260902-profile-address-v1',
  ...
  './supabase-config.js?v=20260901-payment-window-routing-v3',
  ...
  './app/bootstrap.js?v=20260901-payment-window-diagnostics-v2',
  ...
  './app/features/checkout/payment-flow.js?v=20260901-payment-window-diagnostics-v2',
  ...
  './app/features/mypage-settings/mypage-settings.js?v=20260901-mypage-final-v4',
