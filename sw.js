/* 벨로르 PWA 서비스워커 */
const VERSION = "bellore-v340-admin-member-lifecycle";
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './styles.css?v=20260826-admin-catalog-v2',
  ...
  './mypick.css?v=20260826-admin-catalog-v2',
  './bellore-redesign.css?v=20260826-admin-catalog-v2',
  './script.js?v=20260826-admin-catalog-v2',
  './payments.js?v=20260826-admin-catalog-v2',
  './naverpay.js?v=20260728-naver-review-fixes-2',
  './ui-dialog.js?v=20260826-admin-catalog-v2',
  './supabase-config.js?v=20260826-admin-catalog-v2',
  './analytics-core.js?v=20260810-analytics-v3',
  './analytics-client.js?v=20260826-ai-consent-v1',
  './brands.js',
  './supabase.js?v=20260826-admin-catalog-v2',
  './bellore-features.js?v=20260826-admin-catalog-v2',
  './cq-demo.js?v=20260826-admin-catalog-v2',
  './wishlist.js?v=20260826-admin-catalog-v2',
  './alerts.js?v=20260820-tabs-alerts-v1',
  './auction.js?v=20260826-admin-catalog-v2',
  './search.js?v=20260826-admin-catalog-v2',
  './ai-advisor.js?v=20260826-admin-catalog-v2',
  './ai-advisor-admin.js?v=20260826-admin-catalog-v2',
  './app/bootstrap.js?v=20260826-admin-catalog-v2',
  ...
  './app/core/customer-error.mjs?v=20260826-admin-catalog-v2',
  './app/core/listing-display.js?v=20260826-admin-catalog-v2',
  ...
  './app/features/home-merchandising/home-merchandising.js?v=20260826-admin-catalog-v2',
  ...
  './app/features/checkout/checkout-coupon.css?v=20260826-admin-catalog-v2',
  './app/features/checkout/checkout-coupon.js',
  './app/features/home-rows/home-rows.js?v=20260826-admin-catalog-v2',
  './app/features/home-rows/home-rows.css?v=20260826-admin-catalog-v2',
  './app/features/condition-guide/condition-guide.css?v=20260826-admin-catalog-v2',
  './app/features/condition-guide/condition-guide.js?v=20260826-admin-catalog-v2',
  './app/features/listing-availability/listing-availability-ui.js?v=20260826-admin-catalog-v2',
  './app/features/listing-availability/market-static-status.js?v=20260826-admin-catalog-v2',
  './app/features/checkout/payment-flow.js?v=20260826-admin-catalog-v2',
  './app/features/home-rows/home-row-admin.js',
  './app/services/listings/listing-catalog-service.js?v=20260826-admin-catalog-v2',
  './app/services/payments/payment-auth.js?v=20260826-admin-catalog-v2',
  './app/services/payments/checkout-request-recovery.js?v=20260826-admin-catalog-v2',
  './app/services/payments/checkout-client.js?v=20260826-admin-catalog-v2',
  './app/services/payments/payment-network.js?v=20260826-admin-catalog-v2',
  './app/services/payments/pending-payment-recovery.js?v=20260826-admin-catalog-v2',
  './app/legacy/legacy-collection.js?v=20260826-admin-catalog-v2',
  './app/legacy/home-merchandising-grid.js',
  './app/legacy/mypage-settings-adapter.js?v=20260826-mypage-live-v1',
  './app/legacy/member-verification-ui.js?v=20260826-admin-catalog-v2',
  './app/legacy/member-verification-service.js?v=20260826-admin-catalog-v2',
  './app/legacy/customer-feedback.js?v=20260826-admin-catalog-v2',
  './app/legacy/checkout-coupon.js',
  './app/legacy/payment-auth.js',
  './app/legacy/legacy-reveal.js',
  './app/legacy/page-runtime.js?v=20260826-admin-catalog-v2',
  ...
  './app/vendor/recommendation-engine.js?v=20260826-admin-catalog-v2',
  './manifest.json',
  ...
  './app/legacy/recommendation-engine.js?v=20260826-admin-catalog-v2',
