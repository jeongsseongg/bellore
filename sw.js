/* 벨로르 PWA 서비스워커 */
const VERSION = "bellore-v320-featured-showcase";
...
const SHELL_ASSETS = [
  ...
  './mypick.css?v=20260826-featured-showcase-v2',
  './bellore-redesign.css?v=20260826-featured-showcase-v2',
  './app/features/home-banners/home-banners.css?v=20260826-featured-showcase-v2',
  './app/features/home-rows/home-rows.css?v=20260826-featured-showcase-v2',
  './app/features/sell-method/sell-method.css?v=20260826-featured-showcase-v2',
  './script.js?v=20260826-featured-showcase-v2',
  './app/legacy/recommendation-engine.js?v=20260826-featured-showcase-v2',
  './payments.js?v=20260826-featured-showcase-v2',
  ...
  './brands.js',
  './supabase.js?v=20260826-featured-showcase-v2',
  './bellore-features.js?v=20260821-product-detail-v1',
  './cq-demo.js?v=20260810-bid-notify-fix',
  './wishlist.js?v=20260826-featured-showcase-v2',
  './alerts.js?v=20260820-tabs-alerts-v1',
  './auction.js',
  './search.js?v=20260826-featured-showcase-v2',
  './ai-advisor.js?v=20260826-featured-showcase-v2',
  './ai-advisor-admin.js?v=20260826-featured-showcase-v2',
  './app/bootstrap.js?v=20260826-featured-showcase-v2',
  './app/features/sell-method/sell-method.js?v=20260826-featured-showcase-v2',
  './app/core/listing-display.js',
  './app/core/market-product-url.mjs',
  './app/features/home-banners/home-banners.js?v=20260826-featured-showcase-v2',
  './app/features/home-banners/home-banner-data.js',
  './app/features/home-rows/home-rows.js?v=20260826-featured-showcase-v2',
  ...
  './app/legacy/legacy-collection.js?v=20260826-featured-showcase-v2',
  './app/legacy/payment-auth.js',
  './app/legacy/legacy-reveal.js',
  './app/legacy/page-runtime.js?v=20260826-featured-showcase-v2',
