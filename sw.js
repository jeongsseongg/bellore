/* 벨로르 PWA 서비스워커 */
const VERSION = "bellore-v292-hero-campaigns";
...
const SHELL_ASSETS = [
  './',
  './index.html',
  './styles.css?v=20260826-hero-campaigns-v4',
  ...
  './bellore-redesign.css?v=20260826-hero-campaigns-v4',
  './script.js?v=20260826-hero-campaigns-v4',
  './payments.js?v=20260826-hero-campaigns-v4',
  './naverpay.js?v=20260728-naver-review-fixes-2',
  './ui-dialog.js?v=20260826-hero-campaigns-v4',
  ...
  './bellore-features.js?v=20260826-hero-campaigns-v4',
  './cq-demo.js?v=20260826-hero-campaigns-v4',
  './wishlist.js?v=20260824-purl-v2',
  './alerts.js?v=20260820-tabs-alerts-v1',
  './auction.js?v=20260826-hero-campaigns-v4',
  './search.js?v=20260824-purl-v2',
  './ai-advisor.js?v=20260814-kg-card-review',
  './ai-advisor-admin.js?v=20260725-ai-log',
  './app/bootstrap.js?v=20260826-hero-campaigns-v4',
  ...
  './app/features/home-banners/home-banners.css?v=20260826-hero-campaigns-v4',
  './app/features/home-quicklinks/home-quicklinks.js',
  './app/features/home-quicklinks/home-quicklinks.js?v=20260826-hero-campaigns-v4',
  './app/features/home-quicklinks/home-quicklinks.css?v=20260826-hero-campaigns-v4',
  './app/features/checkout/checkout-coupon.css?v=20260826-hero-campaigns-v4',
  './app/features/checkout/checkout-coupon.js',
  './app/features/home-rows/home-rows.js',
  './app/features/home-rows/home-rows.css?v=20260826-hero-campaigns-v4',
  ...
  './app/legacy/page-runtime.js?v=20260826-hero-campaigns-v4',
